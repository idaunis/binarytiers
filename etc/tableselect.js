$(document).ready(function() {
    tableselect_init(this);
});

function tableselect_init(context) {
  $('form table:has(th.select-all):not(.tableSelect-processed)', context).each(TableSelect);
}
...
TableSelect = function() {
  ...
  var strings = { 'selectAll': 'Select all rows in this table', 'selectNone': 'Deselect all rows in this table' };
...
TableSelectRange = function(from, to, state) {
