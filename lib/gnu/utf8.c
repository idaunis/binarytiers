...
static unsigned short xml_encode_iso_8859_1(unsigned char);
static char           xml_decode_iso_8859_1(unsigned short);
static unsigned short xml_encode_us_ascii(unsigned char);
static char           xml_decode_us_ascii(unsigned short);
...
static unsigned short xml_encode_iso_8859_1(unsigned char c)
{
  return (unsigned short)c;
}

static char xml_decode_iso_8859_1(unsigned short c)
{
  return (char)(c > 0xff ? '?' : c);
}

static unsigned short xml_encode_us_ascii(unsigned char c)
{
  return (unsigned short)c;
}

static char xml_decode_us_ascii(unsigned short c)
{
